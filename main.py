...
from src.routes.streamchat import streamchat_bp

from src.routes.revenuecat import revenuecat_bp
...
app.register_blueprint(streamchat_bp, url_prefix='/api/streamchat')
app.register_blueprint(revenuecat_bp, url_prefix='/api')
